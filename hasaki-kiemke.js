...
"#hkReload{background:var(--accent,#1f2937);color:#fff;border:0;border-radius:9px;padding:8px 15px;font-size:12.5px;font-weight:650;cursor:pointer;min-height:36px;}",
"#hkReload:disabled{background:color-mix(in srgb, var(--muted,#9ca3af) 42%, var(--panel,#fff));color:var(--muted,#9ca3af);cursor:not-allowed;}",
/* chip lọc kho (cross-filter cấp tab) */
"#pane-kk .hk-whbar{display:flex;flex-wrap:wrap;gap:6px;align-items:center;margin:0 0 12px;}",
"#pane-kk .hk-whtab{border:1px solid var(--line,#e8ecf1);background:var(--panel,#fff);color:var(--text,#374151);border-radius:999px;padding:6px 13px;font-size:12px;font-weight:600;cursor:pointer;min-height:32px;display:inline-flex;align-items:center;gap:7px;transition:background .16s ease,border-color .16s ease;}",
"#pane-kk .hk-whtab:hover{background:color-mix(in srgb, var(--accent,#2563eb) 8%, transparent);}",
"#pane-kk .hk-whtab.active{background:var(--accent,#1f2937);color:#fff;border-color:var(--accent,#1f2937);}",
...
"#pane-kk .hk-panel{background:var(--panel,#fff);border:1px solid var(--line,#e8ecf1);border-radius:14px;padding:14px 16px;display:flex;flex-direction:column;min-width:0;}",
...
"#pane-kk .hk-strip .ks{flex:1;min-width:0;padding:3px 14px;cursor:pointer;border-left:1px solid var(--line,#e8ecf1);border-radius:8px;transition:background .18s ease;}",
...
"#pane-kk .hk-histchart::after{content:'';position:absolute;left:0;right:0;bottom:30px;border-top:1px solid var(--line,#e8ecf1);}",
...
"#pane-kk .hk-whcard{background:var(--panel,#fff);border:1px solid var(--line,#e8ecf1);border-radius:10px;padding:8px 12px;cursor:pointer;transition:box-shadow .2s ease,background .2s ease;}",
...
"#pane-kk .hk-whtop{display:flex;justify-content:space-between;align-items:center;font-size:12px;gap:8px;}",
"#pane-kk .hk-whname{font-weight:600;line-height:1.25;display:flex;align-items:center;gap:7px;color:var(--text,#1f2937);}",
...
"#pane-kk .hk-spin{width:32px;height:32px;border:3px solid var(--line,#d5dbe4);border-top-color:var(--accent,#2563eb);border-radius:50%;margin:0 auto 16px;animation:hk-sp .8s linear infinite;}",
...
".hk-modalbox{background:var(--panel,#fff);color:var(--text,#1f2937);border-radius:18px;width:min(1280px,96vw);max-height:90vh;display:flex;flex-direction:column;box-shadow:0 24px 60px rgba(16,24,40,.3);transform:translateY(12px) scale(.985);opacity:.6;transition:transform .26s,opacity .26s;will-change:transform;}",
".hk-modal.show .hk-modalbox{transform:none;opacity:1;}",
".hk-modalbox.fcbox{width:min(1080px,96vw);}",
".hk-modalhd{display:flex;justify-content:space-between;align-items:center;padding:16px 20px;border-bottom:1px solid var(--line,#e8ecf1);}",
...
".hk-mfilters{display:flex;flex-wrap:wrap;gap:6px 8px;padding:12px 20px;border-bottom:1px solid var(--line,#e8ecf1);}",
...
".hk-mfilters input{padding:9px 10px;border:1px solid var(--line,#d5dbe4);border-radius:9px;font-size:12.5px;background:var(--panel,#fff);color:var(--text,#1f2937);width:100%;min-height:38px;}",
".hk-mfilters input:focus{outline:0;border-color:var(--accent,#2563eb);}",
".hk-combo{position:relative;}",
".hk-combo-menu{position:absolute;top:calc(100% + 5px);left:0;right:0;z-index:40;background:var(--panel,#fff);border:1px solid var(--line,#e8ecf1);border-radius:11px;box-shadow:0 24px 60px rgba(16,24,40,.28);max-height:250px;overflow-y:auto;overscroll-behavior:contain;padding:5px;opacity:0;visibility:hidden;transform:translateY(-6px);transition:.16s;}",
...
".hk-combo-item.all{border-bottom:1px solid var(--line,#e8ecf1);font-weight:600;}",
".hk-combo-empty{padding:12px;font-size:12px;color:var(--muted,#9ca3af);text-align:center;}",
".hk-msum{padding:9px 20px;font-size:12px;color:var(--muted,#6b7280);border-bottom:1px solid var(--line,#e8ecf1);font-variant-numeric:tabular-nums;}",
...
".hk-wrap{max-height:62vh;overflow:auto;overflow-x:hidden;border:1px solid var(--line,#e8ecf1);border-radius:8px;}",
".hk-wrap table{width:100%;border-collapse:collapse;font-size:12px;min-width:0;color:var(--text,#1f2937);}",
".hk-wrap thead th{position:sticky;top:0;z-index:2;background:var(--accent,#1f2937);color:#fff;font-size:10.5px;font-weight:700;text-transform:uppercase;letter-spacing:.03em;text-align:left;padding:9px 11px;white-space:normal;}",
".hk-wrap tbody td{padding:8px 11px;border-bottom:1px solid var(--line,#f1f4f8);white-space:normal;word-wrap:break-word;vertical-align:top;}",
...
".hk-fcsec{border:1px solid var(--line,#e8ecf1);border-radius:12px;padding:14px 16px;background:color-mix(in srgb, var(--muted,#9ca3af) 6%, var(--panel,#fff));margin:0;}",
...
".hk-fcfact{background:var(--panel,#fff);border:1px solid var(--line,#e8ecf1);border-radius:9px;padding:8px 11px;}",
...
".hk-fcctl input{padding:8px 10px;border:1px solid var(--line,#d5dbe4);border-radius:9px;background:var(--panel,#fff);color:var(--text,#1f2937);font-size:13px;font-family:inherit;}",
...
".hk-fcg{border:1px solid var(--line,#d5dbe4);background:var(--panel,#fff);border-radius:999px;padding:5px 13px;font-size:12px;font-weight:650;cursor:pointer;color:var(--text,#374151);font-family:inherit;transition:background .15s ease,color .15s ease;}",
".hk-fcg.on{background:var(--accent,#2563eb);border-color:var(--accent,#2563eb);color:#fff;}",
...
".hk-fcdate .date-btn{width:100%;text-align:left;cursor:pointer;padding:8px 30px 8px 10px;border:1px solid var(--line,#d5dbe4);border-radius:9px;background:var(--panel,#fff);color:var(--text,#1f2937);font-size:13px;font-family:inherit;}",
...
".hk-datepop{position:fixed;z-index:1300;background:var(--panel,#fff);border:1px solid var(--line,#e8ecf1);border-radius:12px;box-shadow:0 24px 60px rgba(16,24,40,.3);padding:12px;width:max-content;max-width:96vw;overflow:auto;color:var(--text,#1f2937);}",
".hk-datepop.hidden{display:none;}",
".hk-datepop button{border:1px solid var(--line,#d5dbe4);background:var(--panel,#fff);color:var(--text,#1f2937);border-radius:8px;cursor:pointer;font-family:inherit;font-size:12px;padding:5px 12px;font-weight:500;}",
".hk-datepop button:hover{border-color:var(--accent,#2563eb);}",
".hk-datepop button.primary{background:var(--accent,#2563eb);border-color:var(--accent,#2563eb);color:#fff;font-weight:650;}",
...
".hk-datepop .dp-day.edge{background:var(--accent,#2563eb);color:#fff;font-weight:700;}",
".hk-datepop .dp-day.today{box-shadow:inset 0 0 0 1px var(--accent,#2563eb);}",
".hk-datepop .dp-foot{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-top:10px;border-top:1px solid var(--line,#e8ecf1);padding-top:10px;}",
...
function renderWh(){
  ...
  el.innerHTML = ws.map(function(w){
    ...
    return '<div class="hk-whcard' + (S.wh === w ? " active" : "") + '" data-w="' + esc(w) + '" onclick="HKIEMKE.setWh(this.getAttribute(\'data-w\'))" title="Bấm để lọc toàn tab Kiểm kê theo kho này (bấm lại để bỏ lọc)">' +
      ...
      '<div class="hk-prog"><div class="hk-progf" style="width:' + rl.toFixed(1) + "%;background:color-mix(in srgb," + whColor(w) + ' 55%,var(--panel,#fff))"></div></div>' +
