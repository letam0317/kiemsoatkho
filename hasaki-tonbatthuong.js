...
"#htReload{background:var(--accent,#1f2937);color:#fff;border:0;border-radius:9px;padding:8px 15px;font-size:12.5px;font-weight:650;cursor:pointer;min-height:36px;}",
"#htReload:disabled{background:color-mix(in srgb, var(--muted,#9ca3af) 42%, var(--panel,#fff));color:var(--muted,#9ca3af);cursor:not-allowed;}",
/* chip lọc kho */
"#pane-htonbat .ht-whbar{display:flex;flex-wrap:wrap;gap:6px;align-items:center;margin:0 0 12px;}",
"#pane-htonbat .ht-whtab{border:1px solid var(--line,#e8ecf1);background:var(--panel,#fff);color:var(--text,#374151);border-radius:999px;padding:6px 13px;font-size:12px;font-weight:600;cursor:pointer;min-height:32px;display:inline-flex;align-items:center;gap:7px;transition:background .16s ease,border-color .16s ease;}",
"#pane-htonbat .ht-whtab:hover{background:color-mix(in srgb, var(--accent,#2563eb) 8%, transparent);}",
"#pane-htonbat .ht-whtab.active{background:var(--accent,#1f2937);color:#fff;border-color:var(--accent,#1f2937);}",
...
"#pane-htonbat .ht-tile{--cc:var(--accent,#2563eb);background:var(--panel,#fff);border:1px solid var(--line,#e8ecf1);border-left:4px solid var(--cc);border-radius:10px;padding:9px 12px;cursor:pointer;transition:transform .16s cubic-bezier(.32,.72,0,1),box-shadow .25s ease;animation:ht-in .3s ease both;}",
...
"#pane-htonbat .ht-panel{background:var(--panel,#fff);border:1px solid var(--line,#e8ecf1);border-radius:14px;padding:14px 16px;}",
...
"#pane-htonbat .ht-spin{width:32px;height:32px;border:3px solid var(--line,#d5dbe4);border-top-color:var(--accent,#2563eb);border-radius:50%;margin:0 auto 16px;animation:ht-sp .8s linear infinite;}",
...
".ht-modalbox{background:var(--panel,#fff);color:var(--text,#1f2937);border-radius:18px;width:min(1280px,96vw);max-height:90vh;display:flex;flex-direction:column;box-shadow:0 24px 60px rgba(16,24,40,.3);transform:translateY(12px) scale(.985);opacity:.6;transition:transform .26s,opacity .26s;}",
".ht-modal.show .ht-modalbox{transform:none;opacity:1;}",
".ht-modalhd{display:flex;justify-content:space-between;align-items:center;padding:16px 20px;border-bottom:1px solid var(--line,#e8ecf1);}",
...
".ht-mfilters{display:grid;grid-template-columns:1.3fr 1fr 1fr 1.6fr;gap:8px;padding:12px 20px;border-bottom:1px solid var(--line,#e8ecf1);}",
...
".ht-mfilters input{padding:9px 10px;border:1px solid var(--line,#d5dbe4);border-radius:9px;font-size:12.5px;background:var(--panel,#fff);color:var(--text,#1f2937);width:100%;min-height:38px;}",
".ht-mfilters input:focus{outline:0;border-color:var(--accent,#2563eb);}",
".ht-combo{position:relative;}",
".ht-combo-menu{position:absolute;top:calc(100% + 5px);left:0;right:0;z-index:40;background:var(--panel,#fff);border:1px solid var(--line,#e8ecf1);border-radius:11px;box-shadow:0 24px 60px rgba(16,24,40,.28);max-height:250px;overflow-y:auto;overscroll-behavior:contain;padding:5px;opacity:0;visibility:hidden;transform:translateY(-6px);transition:.16s;}",
...
".ht-combo-item.all{border-bottom:1px solid var(--line,#e8ecf1);font-weight:600;}",
".ht-combo-empty{padding:12px;font-size:12px;color:var(--muted,#9ca3af);text-align:center;}",
".ht-msum{padding:9px 20px;font-size:12px;color:var(--muted,#6b7280);border-bottom:1px solid var(--line,#e8ecf1);font-variant-numeric:tabular-nums;}",
...
".ht-mtbl thead th{position:sticky;top:0;background:var(--accent,#1f2937);color:#fff;padding:9px 11px;text-align:left;font-weight:600;font-size:11px;z-index:1;white-space:nowrap;}",
".ht-mtbl td{padding:8px 11px;border-bottom:1px solid var(--line,#f1f4f8);vertical-align:top;white-space:nowrap;}",
